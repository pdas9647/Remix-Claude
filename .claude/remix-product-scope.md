...
### GTM Personas — Surface Matrix by Business Size

> [Notion](https://www.notion.so/1f41d464528f8068895ad839e01e65ab) | Under: 2025 GTM Working Docs [OLD]

| Persona / Business Size               | SoHo                                                                                  | Small/Mid-size (no centralized IT)                                                    | Large/Enterprise (Centralized IT)                                                |
|---------------------------------------|---------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|----------------------------------------------------------------------------------|
| **Developer**                         | App (Mobile+Desktop) · **Studio (Desktop)** · Extension · Agent Server (Remix-hosted) | App (Mobile+Desktop) · **Studio (Desktop)** · Extension · Agent Server (Remix-hosted) | App (Mobile) · Extension · **Studio (Self-hosted)** · Agent Server (Self-hosted) |
| **Assembler** (IT, Ops, PM, Biz Lead) | ← same as Developer                                                                   | App (Mobile+Desktop) · Extension · Agent Server (Remix-hosted)                        | App (Mobile) · Extension · **Studio (Self-hosted)** · Agent Server (Self-hosted) |
| **Individual** (knowledge worker)     | ← same as Developer                                                                   | App (Mobile+Desktop) · Extension · Agent Server (Remix-hosted)                        | App (Mobile+Desktop) · Extension · Agent Server (Self-hosted)                    |

Key pattern: Large enterprise → self-hosted Studio + Agent Server, mobile-only app (no desktop). SoHo/SMB → Remix-hosted, both mobile and desktop.
