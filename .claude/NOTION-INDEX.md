# Remix Labs — Notion Page Index (Full Hierarchy)

> Full sub-page tree for all Notion pages. Top-level quick-ref: see [CLAUDE.md](./CLAUDE.md).
> Each entry notes which topic file stores the stable content.
...
- [Getting Started in Remix Studio](https://www.notion.so/1051d464528f8008b584dd33015fd5b3) — 9-step tutorial (stored in glossary.md)
- [Mobile/Desktop .remix file syncing](https://www.notion.so/25d1d464528f806b8c82e873d275aab7) — _rmx_sync architecture (stored in remix-infra.md)
- [Mobile/Desktop deeplinks](https://www.notion.so/27a1d464528f803db94ac980a0bd84eb) — URL scheme reference (stored in remix-infra.md)
- [Synced preferences](https://www.notion.so/2871d464528f80ae96dfeff9a738ca67) — _rmx_prefs 3-layer cascade (stored in remix-infra.md)
...
- [Mix Language docs](https://www.notion.so/259ede6504e34505982dde5dc4b63d10) — not yet fetched (top-level)
    - [The Mix Standard Library](https://www.notion.so/1061d464528f8010b0cfc60836c20290) — 60+ modules index (stored in mix-std-lib.md)
        - [array](https://www.notion.so/1061d464528f81ef9ff0d976131598d2) — Array operations (stored in mix-lang-core.md)
        - [bool](https://www.notion.so/1061d464528f8157ae0dfdb495fb5c94) — Boolean/Kleenean logic (stored in mix-lang-core.md)
        - [number](https://www.notion.so/1061d464528f81bfb165f1ef2ccf84ac) — Number arithmetic/math/format (stored in mix-lang-core.md)
        - [string](https://www.notion.so/1061d464528f81a1bfa2e1524e618e3a) — String operations (stored in mix-lang-core.md)
        - [set](https://www.notion.so/1061d464528f818fafd7f140445078ab) — Immutable string sets (stored in mix-lang-collections.md)
        - [map](https://www.notion.so/1061d464528f81c1a531d78cea3506ce) — String-keyed maps (stored in mix-lang-collections.md)
        - [gset](https://www.notion.so/1061d464528f817ab66ec31970fd0d06) — Generic sets (stored in mix-lang-collections.md)
        - [uniqArray](https://www.notion.so/604304481fc54c408d28ce8531e3df81) — Unique arrays (stored in mix-lang-collections.md)
        - [option](https://www.notion.so/1061d464528f81c2a019eb7b87dce80a) — Option type: null/some (stored in mix-lang-core.md)
        - [result](https://www.notion.so/1061d464528f81abada4eb1d1645c59c) — Result type: error/ok (stored in mix-lang-core.md)
        - [regex](https://www.notion.so/1061d464528f8195a302ca60a5a3ef98) — Regular expressions (stored in mix-lang-core.md)
        - [bitset](https://www.notion.so/1061d464528f814abf0de4906be6232b) — Integer sets (stored in mix-lang-core.md)
        - [passThrough](https://www.notion.so/1061d464528f81a6bbf9e720f7011c21) — Anonymous cell wrapper (stored in mix-lang-core.md)
        - [db](https://www.notion.so/1061d464528f81d9b074cf5fd60bc600) — Primary DB module: CRUD, query pipeline, filter rules, live queries, references (stored in mix-lang-data.md)
        - [db-changes](https://www.notion.so/1061d464528f81e18307e33a1de8b990) — Migration notes: old→new db API (stored in mix-lang-data.md)
        - [dbRemote](https://www.notion.so/1061d464528f81ceb14cc634b40da637) — HTTP-protocol DB access (stored in mix-lang-data.md)
        - [minidb](https://www.notion.so/1061d464528f81b18087c5c5b68df646) — In-session pure-Mix DB, Wasm-compatible (stored in mix-lang-data.md)
        - [query](https://www.notion.so/1061d464528f818b9732d6b6f321f187) — AST builder for db filters and projections (stored in mix-lang-data.md)
        - [resource](https://www.notion.so/d6783f5009fe471a8e626e37b6598a20) — Static resource URLs, soft-deprecated → use file (stored in mix-lang-data.md)
        - [registry](https://www.notion.so/1061d464528f813f84cad16503e0c479) — Session-scoped case value store, experimental (stored in mix-lang-data.md)
        - [http](https://www.notion.so/1061d464528f81b69f0ef59a0c715d69) — HTTP client: verbs, config options, response shape, URL escaping (stored in mix-lang-io.md)
        - [file](https://www.notion.so/1061d464528f8136b486db76ee013016) — Blob file storage: get/read/list/create/register, client-side upload flow (stored in mix-lang-io.md)
        - [binary](https://www.notion.so/1061d464528f81e481afc195d8d6d92b) — Byte sequences: slice/concat/indexing, UTF-8/Base64/Hex/RmxCode encode-decode (stored in mix-lang-io.md)
        - [crypto](https://www.notion.so/1061d464528f81178aafd26d3c8b51ee) — Hashing (MD5/SHA1/SHA256/HMAC/RSA), AES-GCM encryption (stored in mix-lang-io.md)
        - [wasm](https://www.notion.so/1061d464528f81228b5cd5c0597d6a3e) — WebAssembly FFI: load/funN/wasiLoad/wasiCall (stored in mix-lang-io.md)
        - [mime](https://www.notion.so/1061d464528f81348c86faa717c57bbc) — MIME headers, media types, multipart/form-data (stored in mix-lang-io.md)
        - [stream](https://www.notion.so/1061d464528f81fd8334c07f89c15b0f) — Lazy stream processing: map/filter/reduce/sort/zip/join/tee (stored in mix-lang-stream.md)
        - [xml](https://www.notion.so/11ca20aeafb348a38dde4f513b146001) — XML parse/navigate/search, server-only (stored in mix-lang-stream.md)
        - [websocket](https://www.notion.so/1061d464528f81e8af3dd2ed1d92f1fb) — WebSocket client: read/write/channels/close codes (stored in mix-lang-stream.md)
