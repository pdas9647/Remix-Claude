...
- [Engineering Process](engineering-process.md) — CI (CircleCI, Docker images, secrets), deployment channels (dev/beta/release), release cadence, hot fixes, auto-update chain, operational runbooks, QA, planning
